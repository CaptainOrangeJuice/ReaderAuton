...
void usercontrol(void) {
  ...
  //if (Brain.SDcard.isInserted()) {
    ...
    if (Controller1.ButtonDown.pressing() && Controller1.ButtonLeft.pressing()) {
      Brain.SDcard.savefile( "V_RED_LEFT.dat", (uint8_t*)inputs, sizeof(inputs) );
    ...
    if (Controller1.ButtonDown.pressing() && Controller1.ButtonRight.pressing()) {
      Brain.SDcard.savefile( "V_RED_LEFT.dat", (uint8_t*)emptyData, sizeof(emptyData) );
      int nRead = Brain.SDcard.loadfile( "V_RED_LEFT.dat", (uint8_t*)checkData, sizeof(checkData));
